            ...
            f.Shown+=delegate {
                try {
                    if(operation=="write") {
                        ...
                        Require(saved.Mode==1 && saved.Cq==22 && saved.Bitrate==75.5M && saved.Format==1 && !saved.Checkpoint,"Immediate save");
                        ...
                        Require(!f.Checkpoint.Checked,"Checkpoint preference survived process restart");
                        ...
                        Require(f.Checkpoint.Checked,"Invalid checkpoint preference fallback");
